...
function MRT_enqueue_admin_css( string $hook ): void {
	...
	$ui_deps = array( 'mrt-admin-meta-boxes' );
...
function MRT_enqueue_admin_js(): void {
	...
	wp_enqueue_script( 'mrt-admin-utils', $a . 'admin-utils.js', array( 'jquery', 'mrt-date-utils', 'mrt-string-utils' ), MRT_VERSION, true );
	wp_enqueue_script( 'mrt-admin-route-ui', $a . 'admin-route-ui.js', array( 'mrt-admin-utils', 'jquery' ), MRT_VERSION, true );
	wp_enqueue_script( 'mrt-admin-stoptimes-ui', $a . 'admin-stoptimes-ui.js', array( 'mrt-admin-utils', 'jquery' ), MRT_VERSION, true );
	wp_enqueue_script( 'mrt-admin-timetable-services', $a . 'admin-timetable-services-ui.js', array( 'mrt-admin-utils', 'jquery' ), MRT_VERSION, true );
	wp_enqueue_script( 'mrt-admin-service-edit', $a . 'admin-service-edit.js', array( 'mrt-admin-utils', 'jquery' ), MRT_VERSION, true );
	wp_enqueue_script(
		'mrt-admin',
		$a . 'admin.js',
		array(
...
function MRT_enqueue_frontend_style_admin_triplet(): void {
	...
	wp_enqueue_style(
		...
		array( 'mrt-frontend-base' ),
		MRT_VERSION
	);
	wp_enqueue_style(
		'mrt-frontend-timetable',
		$a . 'admin-timetable.css',
		array( 'mrt-frontend-components' ),
		MRT_VERSION
	);
}
...
function MRT_enqueue_frontend_style_upper_stack( array $meta_box_deps ): void {
	...
	wp_enqueue_style(
		...
		array( 'mrt-frontend-meta-boxes' ),
		MRT_VERSION
	);
	wp_enqueue_style(
		'mrt-frontend-ui',
		$a . 'admin-ui.css',
		array( 'mrt-frontend-dashboard' ),
		MRT_VERSION
	);
	wp_enqueue_style(
		'mrt-frontend-responsive',
		$a . 'admin-responsive.css',
		array( 'mrt-frontend-ui' ),
		MRT_VERSION
	);
}
...
function MRT_enqueue_frontend_base_scripts(): void {
	...
	wp_enqueue_script(
		'mrt-frontend',
		$a . 'frontend.js',
		array( 'jquery', 'mrt-string-utils', 'mrt-frontend-api' ),
		MRT_VERSION,
		true
	);
