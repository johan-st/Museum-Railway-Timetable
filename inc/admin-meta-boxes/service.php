...
function MRT_render_service_meta_box($post) {
    ...
    $timetables = get_posts(['post_type' => 'mrt_timetable', 'posts_per_page' => -1, 'orderby' => 'date', 'order' => 'DESC', 'fields' => 'all']);
    $routes = get_posts(['post_type' => 'mrt_route', 'posts_per_page' => -1, 'orderby' => 'title', 'order' => 'ASC', 'fields' => 'all']);
